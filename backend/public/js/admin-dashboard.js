...
//     const feedbackLink = `${window.location.origin}/index.html?admin=${adminId}`;
...
//             <button class="toggle-btn" id="toggle-${uniqueId}" style="margin:10px 0; cursor:pointer;">Show Details</button>

//             <div class="details" id="details-${uniqueId}" style="display:none; border-top:1px solid #ccc; padding-top:10px; margin-top:10px;">
